...
const arsenal = [
  ...
  },
  {
    ...
    desc: "Für diskrete Gruppen-Extraktionen. Platz für bis zu 8 Bayern-Geschädigte. Kein Volksmusik-Radio verbaut.",
    specs: ["Kapazität: 8 Personen", "Leberkäs-freie Zone", "Spotify statt BR Klassik"],
    status: "EINSATZBEREIT",
  },
  {
    codename: "ALPINE-COM",
    ...
    desc: "Verschlüsselte Kanäle, garantiert frei von Bayerischem Rundfunk. Söder-Warnungen in Echtzeit.",
    specs: ["256-bit Verschlüsselung", "BR-Blocker aktiv", "Söder-Alert-System"],
    status: "EINSATZBEREIT",
  },
];
